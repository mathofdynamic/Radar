...
import { calculateVerification } from "../src/intelligence/verification";
...
const raw = (id: number, text: string): RawPostRow => ({ id, source_id: id, telegram_message_id: id, canonical_url: `https://t.me/s${id}/${id}`, update_type: "create", published_at: new Date().toISOString(), edited_at: null, observed_at: new Date().toISOString(), language: "fa", original_text: text, normalized_text: text, content_hash: "a".repeat(64), media_type: null, raw_html_snippet: null, raw_metadata_json: "{}", is_deleted: 0, is_noise: 0, noise_reason: null, processing_status: "analyzed" });
